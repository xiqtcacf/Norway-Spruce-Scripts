...
do
 ...
 $angsd -vcf-PL bins_vcf_sfs/$i.$batch.recode.vcf -out bins_vcf_sfs/$i.$batch -doSaf 1 -doMajorMinor 1 -anc $fasta -nInd 25 -minQ 30
 $angsd -vcf-PL bins_vcf_sfs/$i.4fold.recode.vcf -out bins_vcf_sfs/$i.4fold -doSaf 1 -doMajorMinor 1 -anc $fasta -nInd 25 -minQ 30
 $realSFS bins_vcf_sfs/$i.$batch.saf.idx -fold 1 > bins_vcf_sfs/$i.$batch.sfs
 $realSFS bins_vcf_sfs/$i.4fold.saf.idx -fold 1 > bins_vcf_sfs/$i.4fold.sfs
...
awk 'NF' sfs1 sfs2 sfs3 sfs4 > input/$batch.$i.sfs
rm $batch.txt 4fold.txt $batch.sfs 4fold.sfs divergence1 divergence2 sfs1 sfs2 sfs3 sfs4
